				...
				<div id={"#login-page-description-container"}>
					<div id={"login-page-description-text-container"}>
						<h2 id={"login-page-description-text-header"}>
							What is Secret Hitler Online?
						</h2>
						<p id={"login-page-description-text"}>
							Secret Hitler Online is an adaptation of the original Secret
							Hitler board game, reimagined for the web. It supports up to 10
							players, featuring smooth art and animations with all the secrecy
							and intrigue of the original. It's designed to be easy to pick up
							and play for any quarantine game night.
							<br />
							<br />
							Play for free in your browser, with no ads ever!
							<br />
							<br />
						</p>
					</div>
					...
					<div id={"login-page-description-text-container"}>
						<p id={"login-page-description-text"}>
							...
							<a
								...
								target={"_blank"}
								rel="noreferrer"
								onClick={this.onClickGameWebsite}
							>
								Secret Hitler
							</a>{" "}
							board game by Goat, Wolf, & Cabbage (© 2016-2020). Developed by
							ShrimpCryptid (© 2020-2023).
							<br />
							<br />
